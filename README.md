...
* I have immplemented all the apis mentioned in EmployeeController which implements IEmployeeInterface.
* JUnit Test cases have also been written. Have used Mockito annotations.
* Have used logging as well using logback slf4j.
* Have used restTemplate to call the downstream applicartion running at port 8112 and fetch all the data.
* Have created Global Exception handelr using custom Exception EmployeeNotFound.
* Have used proper API documentation at Controller and Service layer.
* I have even tested out all the APIs using postman collections. I have attached all postman collections in the project "api" folder itself.
